...
- **No browser notification:** Keep ReviewBee open in a browser tab, click **Enable alerts**, and allow notifications. Browser notifications depend on Supabase Realtime, so rerun `supabase/schema.sql` after pulling version 1.2.1 changes.
